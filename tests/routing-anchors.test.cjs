...
const NAMED = [
  ...
  ['api/_lib/chat.js', 519, 'function imageTurnConfig('],
  ['api/_lib/chat.js', 539, 'const CLAUDE_MODELS'],
  ['api/_lib/chat.js', 545, 'function pickClaudeModel('],
  ['api/_lib/chat.js', 552, 'const OR_MODELS'],
  ['api/_lib/chat.js', 984, 'module.exports = async'],
  ['api/_lib/chat.js', 1005, 'const viaOR'],
  ['api/_lib/chat.js', 1008, 'const apiKey'],
  ['api/_lib/chat.js', 1009, 'ANTHROPIC_API_KEY / OPENROUTER_API_KEY'],
  ['api/_lib/chat.js', 1010, 'const CHAT_URL'],
  ['api/_lib/chat.js', 1016, 'const DEFAULT_MODEL'],
  ['api/_lib/chat.js', 1021, 'pickClaudeModel('],
  ['api/_lib/chat.js', 1071, 'checkAndConsume('],
  ['api/_lib/chat.js', 1072, 'usage.allowed'],
  ['api/_lib/chat.js', 1087, '__freeLane'],
  ['api/_lib/chat.js', 1148, 'const sysParts'],
  ['api/_lib/chat.js', 1155, 'customInstructionsBlock('],
  ['api/_lib/chat.js', 1235, 'imageTurnConfig('],
  ['api/_lib/chat.js', 1279, 'if (__freeLane)'],
  ['api/_lib/chat.js', 1334, 'v-king-fallback'],
