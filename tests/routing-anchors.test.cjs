...
const NAMED = [
  ...
  ['api/_lib/chat.js', 566, 'function pickClaudeModel('],
  ['api/_lib/chat.js', 573, 'const OR_MODELS'],
  ['api/_lib/chat.js', 1013, 'module.exports = async'],
  ['api/_lib/chat.js', 1034, 'let viaOR'],
  ['api/_lib/chat.js', 1037, 'let apiKey'],
