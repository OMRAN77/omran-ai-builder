...
test('index.html: الشعار أوّل عنصر في القائمة الجانبيّة قبل زرّ المحادثة الجديدة، مع مرآة شعار الرأس', () => {
  ...
  assert.match(html, /<div id="sidebarBrand" class="sidebarBrand" title="OM Ai"><span class="omBrand" dir="ltr"><img src="icons\/brand-om-s\.png" alt="OM Ai" class="brandImg" width="141" height="42"><svg class="omStars"/);
