...
// مجلّد تنظيم جديد لكلّ دفعة: /workspace متّسق بالتراخي، وإعادة استخدام نفس المسار
...
// قراءة ملفّ كُتب قبل لحظة في /workspace قد تُرجع بايتات قديمة فتكذب في كلا الاتّجاهين.
