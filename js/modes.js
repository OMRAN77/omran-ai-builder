...
(function(){
  ...
  var MODES = [
    ...
    /* v-ultra-duo: نداءان بالتسلسل — GPT يبني التكوين والنصّ ثمّ نانو برو
       يثري الإخراج بلا إعادة رسم. للمالك وحده الآن (الكلفة مضاعفة)، والبوّابة
       نفسها مطبّقة على الخادم في maha-image.js — تُفتحان معًا لا واحدة. */
    { id:'image_ultra', ar:'صورة خارقة (محرّكان)', en:'Image · ultra (dual engine)', ic:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3l2.1 4.9L19 10l-4.9 2.1L12 17l-2.1-4.9L5 10l4.9-2.1L12 3z"></path><path d="M18 16l.8 1.9L21 19l-2.2.8L18 22l-.8-2.2L15 19l2.2-1.1L18 16z"></path></svg>', owner:true },
