...
(function(){
  ...
  var MODES = [
    ...
    /* v-img-mix (المالك ٢٣ سبتمبر: «خاصيّة + دمج بين نانو وGPT — النتيجة ١»): المحرّكان معًا على الطلب نفسه (توليدًا أو تعديلًا
       لصورة مرفقة) بالأمر المهندس لا الخام، وحاكم ينفّذ أوّلًا يختار صورة واحدة. للمالك وحده كبقيّة أوضاع المحرّك. */
