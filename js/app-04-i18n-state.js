...
function omranGoldBadgeCss(){
  ...
  st.textContent =
    ...
    + '.attach-chip.goldBadge .gbTxt{flex:1;min-width:0;text-align:start;unicode-bidi:plaintext;}'
    ...
    + '.attach-chip.goldBadge .rm{position:absolute;left:13px;right:auto;top:50%;transform:translateY(-50%);'
