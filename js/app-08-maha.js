...
const __IMG_MAKE_RE = /ارسم|أرسم|ارسمي|صمم|صمّم|اصمم|اصنع|اعمل لي|سوي لي|سوّي لي|ولّد|ولد لي|حوّل|عدّل|اقتطع|ازل الخلفية|أزل الخلفية|generate|create an image|draw|design|edit it|remove background|هذه الصورة|هالصورة|الصورة المرفقة|في الصورة|بالصورة|(?:عطني|أعطني|اعطني|هات|ابا|أبا|ابي|أبي|ابغي|أبغي|ابغى|أبغى|اريد|أريد|سو|سوي|سوّي|اعمل|أعمل|give me|make me|i want)\s+(?:لي\s+)?[^\n]{0,20}?(?:تصميم|تصور|صور[هة]?|رسم[هة]?|design|image|picture)/i; // v656: «أريد صورة…» = توليد بالذكاء الاصطناعي، لا شريط صور جوجل
