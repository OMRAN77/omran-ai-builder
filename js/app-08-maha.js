...
const __RECIPE_IMG_RE = /(?:^|[\s،,])(?:ط[ري]ق[هة](?:\s+(?:طبخ|تحضير|عمل|صنع|الطبخ|التحضير))?|وصف[هة](?=[\s،]|$)|مكونات(?=[\s،]|$)|تحضير(?=\s)|المقادير(?=[\s،]|$)|[أا]طبخ\s|[أا]عمل\s(?!لي)|[أا]صنع\s|سوّ?[يى]\s)|(?:كيف\s+[أا]?(?:طبخ|عمل|صنع|حضّر|حضر|سوّ?[يى]|أعمل|اعمل|أطبخ|اطبخ))\s|(?:طبخة|أكلة|وجبة)\s+\S|(?:how to\s+(?:cook|make|prepare|bake))\s|(?:recipe\s+(?:for|of))\s/i;
const __RECIPE_STRIP_RE2 = /(?:ط[ري]ق[هة](?:\s+(?:طبخ|تحضير|عمل|صنع|الطبخ|التحضير|العمل|الصنع))?|وصف[هة]|مكونات|المقادير|كيف\s+[أا]?(?:طبخ|عمل|صنع|حضّر|حضر|سوّ?[يى]|أعمل|اعمل|أطبخ|اطبخ)|تحضير|[أا]طبخ|[أا]عمل|[أا]صنع|طبخة|أكلة|وجبة|how to\s+(?:cook|make|prepare|bake)|recipe\s*(?:for|of)?|ingredients?\s*(?:for|of)?)/gi;
