...
// ===== Payment Patch: Apple Pay / Google Pay + Stripe wallet support =====
// Added because app.bundle.js cannot be updated via API (too large).
// These functions are called by the checkout modal buttons in partials-settings.js.
...
// Override openCheckout to add wallet setup
...
// Override startStripeCheckout to include auth token
