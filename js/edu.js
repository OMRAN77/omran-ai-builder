...
var I18N={
ar:{title:'التعليم',oldEdu:'📚 دورات وشروحات',upload:'ارفع محاضرة جديدة',uploadSub:'PDF أو صور أو DOCX',orPaste:'أو الصق نصًا',pastePh:'الصق نص المحاضرة هنا...',analyze:'حلّل المحاضرة',analyzing:'⏳ نحلل المحاضرة… قد يستغرق الأمر دقيقة',mySubjects:'📚 موادي',empty:'لا توجد دروس بعد — ارفع أول محاضرة وابدأ المذاكرة!',lessonsWord:'درس',summaryTab:'📄 الملخص',cardsTab:'🎴 بطاقات',quizTab:'✍️ اختبار',know:'أعرفه ✅',review:'أراجعه 🔄',tapFlip:'اضغط على البطاقة لقلبها',retry:'أعد الاختبار',yourScore:'نتيجتك',great:'ممتاز! أنت جاهز للامتحان 🌟',good:'جيد جدًا! راجع الأخطاء وستتقنها 💪',keepGoing:'بداية طيبة — راجع الملخص والبطاقات ثم أعد المحاولة 📖',del:'حذف',confirmDel:'حذف هذا الدرس نهائيًا؟',err:'حدث خطأ، حاول مرة أخرى.',guestNote:'أنت غير مسجّل — تُحفظ دروسك على هذا الجهاز فقط.',intro:'جديد: 🎓 التعليم — ارفع محاضرتك واحصل على ملخص وبطاقات واختبار',introBtn:'جرّبه الآن',hint:'💡 جرّب قسم «التعليم»: ارفع محاضرتك واحصل على ملخص وبطاقات واختبار تلقائيًا',docxFail:'تعذر قراءة ملف DOCX — جرّب حفظه كـ PDF ورفعه.',tooBig:'الملف كبير جدًا (الحد حوالي 10 ميغابايت).',cardsDone:'أنهيت كل البطاقات! 🎉',finish:'إنهاء',next:'التالي',streakWord:'يوم',lvlBasic:'أساسي',lvlMid:'متوسط',lvlAdv:'متقدّم',focusLevel:'ركّز مراجعتك على مستوى {lvl}',writtenBtn:'أسئلة مقالية ✍️',reviewLbl:'راجع: ',writtenDone:'أنهيت الأسئلة المقالية.',back:'رجوع',answerPh:'اكتب إجابتك هنا…',gradeMine:'صحّح إجابتي',answerFirst:'اكتب إجابتك أولًا.',grading:'جارٍ التصحيح…',youCovered:'أصبتَ في:',youMissed:'نقصك:',gradedAgainst:'على أي أساس صُحِّحت إجابتي؟',contest:'راجع تصحيحي',studyEstimate:'هذا تقدير للمذاكرة، وليس درجة رسمية.',whyUnfair:'لماذا ترى أن التصحيح غير منصف؟',gradeFail:'تعذّر التصحيح.',close:'إغلاق',examLangLabel:'لغة امتحاني',examLangHint:'الشرح بلغتك، والمصطلحات بلغة الامتحان.',subjGeneric:'عام',okBtn:'حسنًا',badType:'نوع الملف غير مدعوم هنا. رفع المحاضرة يقبل: PDF أو DOCX أو ZIP أو صور.',badTypeHint:'أما ملفات الكود والمشاريع فتُرفع من زر 📎 إرفاق داخل المحادثة.',zipNoText:'لا يوجد نص قابل للقراءة داخل الأرشيف. ارفع PDF أو صورًا للمحاضرة.',zipEmpty:'الأرشيف فارغ من النصوص.',zipOpenFail:'تعذّر فتح الأرشيف.',zipToolFail:'تعذّر تحميل أداة فكّ الضغط. تحقّق من الاتصال.'},
en:{title:'Education',oldEdu:'📚 Courses & Lessons',upload:'Upload a new lecture',uploadSub:'PDF, images or DOCX',orPaste:'or paste text',pastePh:'Paste your lecture text here...',analyze:'Analyze lecture',analyzing:'⏳ Analyzing your lecture… this may take a minute',mySubjects:'📚 My subjects',empty:'No lessons yet — upload your first lecture to start studying!',lessonsWord:'lesson(s)',summaryTab:'📄 Summary',cardsTab:'🎴 Flashcards',quizTab:'✍️ Quiz',know:'I know it ✅',review:'Review 🔄',tapFlip:'Tap the card to flip it',retry:'Retake quiz',yourScore:'Your score',great:'Excellent! You are exam-ready 🌟',good:'Very good! Review your mistakes and you will master it 💪',keepGoing:'Good start — review the summary and cards, then try again 📖',del:'Delete',confirmDel:'Delete this lesson permanently?',err:'Something went wrong, please try again.',guestNote:'You are not signed in — lessons are saved on this device only.',intro:'New: 🎓 Education — upload a lecture and get a summary, flashcards and a quiz',introBtn:'Try it now',hint:'💡 Try "Education": upload your lecture and get a summary, flashcards and a quiz automatically',docxFail:'Could not read the DOCX file — try saving it as PDF.',tooBig:'File too large (limit is about 10 MB).',cardsDone:'You finished all the cards! 🎉',finish:'Finish',next:'Next',streakWord:'day(s)',lvlBasic:'Basic',lvlMid:'Intermediate',lvlAdv:'Advanced',focusLevel:'Focus your review on the {lvl} level.',writtenBtn:'Written questions ✍️',reviewLbl:'Review: ',writtenDone:'You finished the written questions.',back:'Back',answerPh:'Write your answer here…',gradeMine:'Grade my answer',answerFirst:'Write your answer first.',grading:'Grading…',youCovered:'You covered:',youMissed:'You missed:',gradedAgainst:'What was I graded against?',contest:'Contest this',studyEstimate:'This is a study estimate, not an official grade.',whyUnfair:'Why do you think the grading was unfair?',gradeFail:'Grading failed.',close:'Close',examLangLabel:'My exam language',examLangHint:'Explanations stay in your language; terms follow the exam.',subjGeneric:'General',okBtn:'OK',badType:'This file type is not supported here. Lecture upload accepts: PDF, DOCX, ZIP or images.',badTypeHint:'Code and project files are uploaded with the 📎 attach button in chat.',zipNoText:'No readable text inside the archive. Upload a PDF or images of the lecture.',zipEmpty:'The archive contains no text.',zipOpenFail:'Could not open the archive.',zipToolFail:'Could not load the unzip tool. Check your connection.'},
fr:{title:'Mes cours',oldEdu:'📚 Cours et tutoriels',upload:'Téléverser un nouveau cours',orPaste:'ou coller du texte',analyze:'Analyser le cours',analyzing:'⏳ Analyse du cours en cours…',mySubjects:'📚 Mes matières',empty:'Aucune leçon — téléversez votre premier cours !',summaryTab:'📄 Résumé',cardsTab:'🎴 Cartes',quizTab:'✍️ Quiz',know:'Je sais ✅',review:'À revoir 🔄',tapFlip:'Touchez la carte pour la retourner',retry:'Refaire le quiz',yourScore:'Votre score',great:'Excellent ! Vous êtes prêt 🌟',good:'Très bien ! Revoyez vos erreurs 💪',keepGoing:'Bon début — relisez le résumé puis réessayez 📖',del:'Supprimer',confirmDel:'Supprimer cette leçon ?',err:'Une erreur est survenue.',guestNote:'Non connecté — leçons enregistrées sur cet appareil.',intro:'Nouveau : 🎓 Mes cours — résumé, cartes et quiz automatiques',introBtn:'Essayer',hint:'💡 Essayez « Mes cours » : résumé, cartes et quiz automatiques',next:'Suivant',finish:'Terminer',lvlBasic:'Basique',lvlMid:'Intermédiaire',lvlAdv:'Avancé',focusLevel:'Concentre ta révision sur le niveau {lvl}.',writtenBtn:'Questions rédigées ✍️',reviewLbl:'Révision : ',writtenDone:'Tu as terminé les questions rédigées.',back:'Retour',answerPh:'Écris ta réponse ici…',gradeMine:'Corriger ma réponse',answerFirst:'Écris d\'abord ta réponse.',grading:'Correction en cours…',youCovered:'Tu as bien traité :',youMissed:'Ce qu\'il te manque :',gradedAgainst:'Sur quelle base ma réponse a-t-elle été corrigée ?',contest:'Contester cette correction',studyEstimate:'Ceci est une estimation d\'étude, pas une note officielle.',whyUnfair:'Pourquoi penses-tu que cette correction est injuste ?',gradeFail:'La correction a échoué.',close:'Fermer',uploadSub:'PDF, images ou DOCX',pastePh:'Colle le texte du cours ici...',lessonsWord:'leçon(s)',docxFail:'Impossible de lire le fichier DOCX — essaie de l\'enregistrer en PDF.',tooBig:'Le fichier est trop volumineux (limite d\'environ 10 Mo).',cardsDone:'Tu as terminé toutes les cartes ! 🎉',streakWord:'jour(s)',examLangLabel:'Ma langue d\'examen',examLangHint:'Les explications restent dans votre langue ; les termes suivent la langue de l\'examen.',subjGeneric:'Général',okBtn:'OK',badType:'Ce type de fichier n\'est pas pris en charge ici. Le dépôt de cours accepte : PDF, DOCX, ZIP ou images.',badTypeHint:'Les fichiers de code et de projet se déposent avec le bouton 📎 dans la discussion.',zipNoText:'Aucun texte lisible dans l\'archive. Déposez un PDF ou des images du cours.',zipEmpty:'L\'archive ne contient aucun texte.',zipOpenFail:'Impossible d\'ouvrir l\'archive.',zipToolFail:'Impossible de charger l\'outil de décompression. Vérifiez votre connexion.'},
hi:{title:'मेरे पाठ',oldEdu:'📚 कोर्स और पाठ',upload:'नया लेक्चर अपलोड करें',orPaste:'या टेक्स्ट पेस्ट करें',analyze:'लेक्चर का विश्लेषण करें',analyzing:'⏳ लेक्चर का विश्लेषण हो रहा है…',mySubjects:'📚 मेरे विषय',empty:'अभी कोई पाठ नहीं — पहला लेक्चर अपलोड करें!',summaryTab:'📄 सारांश',cardsTab:'🎴 कार्ड',quizTab:'✍️ क्विज़',know:'आता है ✅',review:'दोहराना 🔄',tapFlip:'पलटने के लिए कार्ड पर टैप करें',retry:'क्विज़ दोबारा दें',yourScore:'आपका स्कोर',great:'शानदार! आप तैयार हैं 🌟',good:'बहुत अच्छा! गलतियाँ दोहराएँ 💪',keepGoing:'अच्छी शुरुआत — सारांश पढ़कर फिर कोशिश करें 📖',del:'हटाएँ',confirmDel:'यह पाठ हटाएँ?',err:'कुछ गलत हुआ, फिर कोशिश करें।',guestNote:'लॉगिन नहीं — पाठ इसी डिवाइस पर सहेजे जाते हैं।',intro:'नया: 🎓 मेरे पाठ — सारांश, कार्ड और क्विज़ अपने आप',introBtn:'आज़माएँ',hint:'💡 «मेरे पाठ» आज़माएँ: लेक्चर से सारांश, कार्ड और क्विज़',next:'आगे',finish:'समाप्त',lvlBasic:'बुनियादी',lvlMid:'मध्यम',lvlAdv:'उन्नत',focusLevel:'{lvl} स्तर पर अपनी रिवीज़न पर ध्यान दें।',writtenBtn:'निबंधात्मक प्रश्न ✍️',reviewLbl:'रिवीज़न: ',writtenDone:'आपने निबंधात्मक प्रश्न पूरे कर लिए।',back:'वापस',answerPh:'अपना उत्तर यहाँ लिखें…',gradeMine:'मेरा उत्तर जांचें',answerFirst:'पहले अपना उत्तर लिखें।',grading:'जांच हो रही है…',youCovered:'आपने यह सही किया:',youMissed:'आपसे यह छूट गया:',gradedAgainst:'मेरे उत्तर की जांच किस आधार पर हुई?',contest:'इस जांच पर आपत्ति करें',studyEstimate:'यह एक अध्ययन अनुमान है, आधिकारिक अंक नहीं।',whyUnfair:'आपको क्यों लगता है कि यह जांच अनुचित थी?',gradeFail:'जांच नहीं हो पाई।',close:'बंद करें',uploadSub:'PDF, तस्वीरें या DOCX',pastePh:'अपने पाठ का टेक्स्ट यहाँ पेस्ट करें...',lessonsWord:'पाठ',docxFail:'DOCX फ़ाइल पढ़ी नहीं जा सकी — इसे PDF में सेव करके देखें।',tooBig:'फ़ाइल बहुत बड़ी है (सीमा लगभग 10 MB है)।',cardsDone:'आपने सभी कार्ड पूरे कर लिए! 🎉',streakWord:'दिन',examLangLabel:'मेरी परीक्षा की भाषा',examLangHint:'स्पष्टीकरण आपकी भाषा में रहेंगे; शब्दावली परीक्षा की भाषा में होगी।',subjGeneric:'सामान्य',okBtn:'ठीक है',badType:'यह फ़ाइल प्रकार यहाँ समर्थित नहीं है। लेक्चर अपलोड के लिए स्वीकृत: PDF, DOCX, ZIP या इमेज।',badTypeHint:'कोड और प्रोजेक्ट फ़ाइलें चैट में 📎 अटैच बटन से अपलोड करें।',zipNoText:'आर्काइव के भीतर पढ़ने योग्य टेक्स्ट नहीं है। लेक्चर का PDF या इमेज अपलोड करें।',zipEmpty:'आर्काइव में कोई टेक्स्ट नहीं है।',zipOpenFail:'आर्काइव खोला नहीं जा सका।',zipToolFail:'अनज़िप टूल लोड नहीं हो सका। अपना कनेक्शन जाँचें।'},
ur:{title:'میرے اسباق',oldEdu:'📚 کورسز اور اسباق',upload:'نیا لیکچر اپ لوڈ کریں',orPaste:'یا متن پیسٹ کریں',analyze:'لیکچر کا تجزیہ کریں',analyzing:'⏳ لیکچر کا تجزیہ ہو رہا ہے…',mySubjects:'📚 میرے مضامین',empty:'ابھی کوئی سبق نہیں — پہلا لیکچر اپ لوڈ کریں!',summaryTab:'📄 خلاصہ',cardsTab:'🎴 کارڈز',quizTab:'✍️ کوئز',know:'آتا ہے ✅',review:'دہرانا 🔄',tapFlip:'پلٹنے کے لیے کارڈ پر ٹیپ کریں',retry:'کوئز دوبارہ دیں',yourScore:'آپ کا اسکور',great:'زبردست! آپ تیار ہیں 🌟',good:'بہت خوب! غلطیاں دہرائیں 💪',keepGoing:'اچھی شروعات — خلاصہ پڑھ کر دوبارہ کوشش کریں 📖',del:'حذف کریں',confirmDel:'یہ سبق حذف کریں؟',err:'کچھ غلط ہوا، دوبارہ کوشش کریں۔',guestNote:'لاگ اِن نہیں — اسباق صرف اسی ڈیوائس پر محفوظ ہوتے ہیں۔',intro:'نیا: 🎓 میرے اسباق — خلاصہ، کارڈز اور کوئز خودکار',introBtn:'آزمائیں',hint:'💡 «میرے اسباق» آزمائیں: لیکچر سے خلاصہ، کارڈز اور کوئز',next:'اگلا',finish:'ختم',lvlBasic:'بنیادی',lvlMid:'درمیانی',lvlAdv:'اعلیٰ',focusLevel:'اپنی نظرثانی {lvl} سطح پر مرکوز رکھیں۔',writtenBtn:'تحریری سوالات ✍️',reviewLbl:'نظرثانی: ',writtenDone:'آپ نے تحریری سوالات مکمل کر لیے۔',back:'واپس',answerPh:'اپنا جواب یہاں لکھیں…',gradeMine:'میرا جواب چیک کریں',answerFirst:'پہلے اپنا جواب لکھیں۔',grading:'چیک ہو رہا ہے…',youCovered:'آپ نے یہ درست کیا:',youMissed:'آپ سے یہ رہ گیا:',gradedAgainst:'میرے جواب کو کس بنیاد پر چیک کیا گیا؟',contest:'اس چیکنگ پر اعتراض کریں',studyEstimate:'یہ مطالعے کا تخمینہ ہے، سرکاری نمبر نہیں۔',whyUnfair:'آپ کے خیال میں یہ چیکنگ غیر منصفانہ کیوں تھی؟',gradeFail:'چیک نہیں ہو سکا۔',close:'بند کریں',uploadSub:'PDF، تصاویر یا DOCX',pastePh:'لیکچر کا متن یہاں پیسٹ کریں...',lessonsWord:'سبق',docxFail:'DOCX فائل پڑھی نہیں جا سکی — اسے PDF میں محفوظ کر کے آزمائیں۔',tooBig:'فائل بہت بڑی ہے (حد تقریباً 10 MB ہے)۔',cardsDone:'آپ نے تمام کارڈز مکمل کر لیے! 🎉',streakWord:'دن',examLangLabel:'میری امتحان کی زبان',examLangHint:'وضاحتیں آپ کی زبان میں رہیں گی؛ اصطلاحات امتحان کی زبان کے مطابق ہوں گی۔',subjGeneric:'عمومی',okBtn:'ٹھیک ہے',badType:'یہ فائل کی قسم یہاں معاون نہیں ہے۔ لیکچر اپلوڈ صرف قبول کرتا ہے: PDF، DOCX، ZIP یا تصاویر۔',badTypeHint:'کوڈ اور پراجیکٹ فائلیں چیٹ میں 📎 اٹیچ بٹن سے اپلوڈ کریں۔',zipNoText:'آرکائیو میں پڑھنے کے قابل متن موجود نہیں۔ لیکچر کا PDF یا تصاویر اپلوڈ کریں۔',zipEmpty:'آرکائیو میں کوئی متن موجود نہیں۔',zipOpenFail:'آرکائیو کھولا نہیں جا سکا۔',zipToolFail:'ان زپ ٹول لوڈ نہیں ہو سکا۔ اپنا کنکشن چیک کریں۔'},
bn:{title:'আমার পাঠ',oldEdu:'📚 কোর্স ও পাঠ',upload:'নতুন লেকচার আপলোড করুন',orPaste:'বা টেক্সট পেস্ট করুন',analyze:'লেকচার বিশ্লেষণ করুন',analyzing:'⏳ লেকচার বিশ্লেষণ চলছে…',mySubjects:'📚 আমার বিষয়',empty:'এখনও কোনো পাঠ নেই — প্রথম লেকচার আপলোড করুন!',summaryTab:'📄 সারাংশ',cardsTab:'🎴 কার্ড',quizTab:'✍️ কুইজ',know:'জানি ✅',review:'আবার 🔄',tapFlip:'উল্টাতে কার্ডে ট্যাপ করুন',retry:'আবার কুইজ দিন',yourScore:'আপনার স্কোর',great:'চমৎকার! আপনি প্রস্তুত 🌟',good:'খুব ভালো! ভুলগুলো দেখুন 💪',keepGoing:'ভালো শুরু — সারাংশ পড়ে আবার চেষ্টা করুন 📖',del:'মুছুন',confirmDel:'এই পাঠ মুছবেন?',err:'সমস্যা হয়েছে, আবার চেষ্টা করুন।',guestNote:'লগইন নেই — পাঠ এই ডিভাইসেই সংরক্ষিত।',intro:'নতুন: 🎓 আমার পাঠ — সারাংশ, কার্ড ও কুইজ স্বয়ংক্রিয়',introBtn:'চেষ্টা করুন',hint:'💡 «আমার পাঠ» দেখুন: লেকচার থেকে সারাংশ, কার্ড ও কুইজ',next:'পরবর্তী',finish:'শেষ',lvlBasic:'মৌলিক',lvlMid:'মধ্যম',lvlAdv:'উচ্চতর',focusLevel:'{lvl} স্তরের ওপর আপনার রিভিশন কেন্দ্রীভূত করুন।',writtenBtn:'রচনামূলক প্রশ্ন ✍️',reviewLbl:'রিভিশন: ',writtenDone:'আপনি রচনামূলক প্রশ্নগুলো শেষ করেছেন।',back:'পিছনে',answerPh:'আপনার উত্তর এখানে লিখুন…',gradeMine:'আমার উত্তর যাচাই করুন',answerFirst:'প্রথমে আপনার উত্তর লিখুন।',grading:'যাচাই করা হচ্ছে…',youCovered:'আপনি সঠিক করেছেন:',youMissed:'আপনার যা বাকি রয়ে গেছে:',gradedAgainst:'কোন ভিত্তিতে আমার উত্তর যাচাই করা হয়েছে?',contest:'এই যাচাইয়ে আপত্তি করুন',studyEstimate:'এটি একটি অধ্যয়ন অনুমান, অফিসিয়াল নম্বর নয়।',whyUnfair:'আপনি কেন মনে করেন এই যাচাই অন্যায্য ছিল?',gradeFail:'যাচাই করা যায়নি।',close:'বন্ধ করুন',uploadSub:'PDF, ছবি বা DOCX',pastePh:'লেকচারের লেখা এখানে পেস্ট করুন...',lessonsWord:'পাঠ',docxFail:'DOCX ফাইল পড়া যায়নি — এটি PDF হিসেবে সেভ করে দেখুন।',tooBig:'ফাইলটি খুব বড় (সীমা প্রায় 10 MB)।',cardsDone:'আপনি সব কার্ড শেষ করেছেন! 🎉',streakWord:'দিন',examLangLabel:'আমার পরীক্ষার ভাষা',examLangHint:'ব্যাখ্যা আপনার ভাষায় থাকবে; পরিভাষা পরীক্ষার ভাষা অনুসরণ করবে।',subjGeneric:'সাধারণ',okBtn:'ঠিক আছে',badType:'এই ফাইলের ধরন এখানে সমর্থিত নয়। লেকচার আপলোডে গ্রহণযোগ্য: PDF, DOCX, ZIP বা ছবি।',badTypeHint:'কোড ও প্রজেক্ট ফাইল চ্যাটের 📎 অ্যাটাচ বাটন থেকে আপলোড করুন।',zipNoText:'আর্কাইভের ভেতরে পড়ার উপযোগী কোনো টেক্সট নেই। লেকচারের PDF বা ছবি আপলোড করুন।',zipEmpty:'আর্কাইভে কোনো টেক্সট নেই।',zipOpenFail:'আর্কাইভ খোলা যায়নি।',zipToolFail:'আনজিপ টুল লোড করা যায়নি। আপনার সংযোগ পরীক্ষা করুন।'},
ne:{title:'मेरा पाठहरू',oldEdu:'📚 कोर्स र पाठहरू',upload:'नयाँ लेक्चर अपलोड गर्नुहोस्',orPaste:'वा टेक्स्ट टाँस्नुहोस्',analyze:'लेक्चर विश्लेषण गर्नुहोस्',analyzing:'⏳ लेक्चर विश्लेषण हुँदैछ…',mySubjects:'📚 मेरा विषयहरू',empty:'अहिले कुनै पाठ छैन — पहिलो लेक्चर अपलोड गर्नुहोस्!',summaryTab:'📄 सारांश',cardsTab:'🎴 कार्ड',quizTab:'✍️ क्विज',know:'थाहा छ ✅',review:'दोहोर्‍याउने 🔄',tapFlip:'पल्टाउन कार्डमा ट्याप गर्नुहोस्',retry:'क्विज फेरि दिनुहोस्',yourScore:'तपाईंको स्कोर',great:'उत्कृष्ट! तपाईं तयार हुनुहुन्छ 🌟',good:'धेरै राम्रो! गल्ती हेर्नुहोस् 💪',keepGoing:'राम्रो सुरुवात — सारांश पढेर फेरि प्रयास गर्नुहोस् 📖',del:'हटाउनुहोस्',confirmDel:'यो पाठ हटाउने?',err:'केही गडबड भयो, फेरि प्रयास गर्नुहोस्।',guestNote:'लगइन छैन — पाठ यही डिभाइसमा मात्र सुरक्षित।',intro:'नयाँ: 🎓 मेरा पाठहरू — सारांश, कार्ड र क्विज स्वतः',introBtn:'प्रयास गर्नुहोस्',hint:'💡 «मेरा पाठहरू» हेर्नुहोस्: लेक्चरबाट सारांश, कार्ड र क्विज',next:'अर्को',finish:'सकियो',lvlBasic:'आधारभूत',lvlMid:'मध्यम',lvlAdv:'उच्च',focusLevel:'{lvl} तहमा आफ्नो पुनरावलोकन केन्द्रित गर्नुहोस्।',writtenBtn:'लेखात्मक प्रश्नहरू ✍️',reviewLbl:'पुनरावलोकन: ',writtenDone:'तपाईंले लेखात्मक प्रश्नहरू पूरा गर्नुभयो।',back:'पछाडि',answerPh:'आफ्नो जवाफ यहाँ लेख्नुहोस्…',gradeMine:'मेरो जवाफ जाँच गर्नुहोस्',answerFirst:'पहिले आफ्नो जवाफ लेख्नुहोस्।',grading:'जाँच हुँदैछ…',youCovered:'तपाईंले यो ठीक गर्नुभयो:',youMissed:'तपाईंले यो छुटाउनुभयो:',gradedAgainst:'मेरो जवाफ केको आधारमा जाँचियो?',contest:'यो जाँचमा आपत्ति जनाउनुहोस्',studyEstimate:'यो अध्ययन अनुमान हो, आधिकारिक अंक होइन।',whyUnfair:'तपाईंलाई किन लाग्छ यो जाँच अन्यायपूर्ण थियो?',gradeFail:'जाँच गर्न सकिएन।',close:'बन्द गर्नुहोस्',uploadSub:'PDF, तस्बिरहरू वा DOCX',pastePh:'लेक्चरको पाठ यहाँ टाँस्नुहोस्...',lessonsWord:'पाठ',docxFail:'DOCX फाइल पढ्न सकिएन — यसलाई PDF मा सेभ गरी हेर्नुहोस्।',tooBig:'फाइल धेरै ठूलो छ (सीमा लगभग 10 MB हो)।',cardsDone:'तपाईंले सबै कार्डहरू पूरा गर्नुभयो! 🎉',streakWord:'दिन',examLangLabel:'मेरो परीक्षाको भाषा',examLangHint:'व्याख्या तपाईंको भाषामा हुनेछ; शब्दावली परीक्षाको भाषा अनुसार हुनेछ।',subjGeneric:'सामान्य',okBtn:'ठीक छ',badType:'यो फाइल प्रकार यहाँ समर्थित छैन। लेक्चर अपलोडले स्वीकार गर्छ: PDF, DOCX, ZIP वा तस्बिरहरू।',badTypeHint:'कोड र प्रोजेक्ट फाइलहरू च्याटको 📎 अट्याच बटनबाट अपलोड गर्नुहोस्।',zipNoText:'अभिलेखागार भित्र पढ्न मिल्ने टेक्स्ट छैन। लेक्चरको PDF वा तस्बिरहरू अपलोड गर्नुहोस्।',zipEmpty:'अभिलेखागारमा कुनै टेक्स्ट छैन।',zipOpenFail:'अभिलेखागार खोल्न सकिएन।',zipToolFail:'अनजिप टुल लोड हुन सकेन। आफ्नो कनेक्शन जाँच्नुहोस्।'},
id:{title:'Pelajaranku',oldEdu:'📚 Kursus & Pelajaran',upload:'Unggah kuliah baru',orPaste:'atau tempel teks',analyze:'Analisis kuliah',analyzing:'⏳ Menganalisis kuliah…',mySubjects:'📚 Mata pelajaranku',empty:'Belum ada pelajaran — unggah kuliah pertamamu!',summaryTab:'📄 Ringkasan',cardsTab:'🎴 Kartu',quizTab:'✍️ Kuis',know:'Sudah paham ✅',review:'Ulangi 🔄',tapFlip:'Ketuk kartu untuk membalik',retry:'Ulangi kuis',yourScore:'Skormu',great:'Luar biasa! Kamu siap ujian 🌟',good:'Bagus sekali! Tinjau kesalahanmu 💪',keepGoing:'Awal yang baik — baca ringkasan lalu coba lagi 📖',del:'Hapus',confirmDel:'Hapus pelajaran ini?',err:'Terjadi kesalahan, coba lagi.',guestNote:'Belum masuk — pelajaran disimpan di perangkat ini saja.',intro:'Baru: 🎓 Pelajaranku — ringkasan, kartu, dan kuis otomatis',introBtn:'Coba sekarang',hint:'💡 Coba "Pelajaranku": unggah kuliah, dapatkan ringkasan, kartu & kuis',next:'Berikutnya',finish:'Selesai',lvlBasic:'Dasar',lvlMid:'Menengah',lvlAdv:'Lanjutan',focusLevel:'Fokuskan ulasanmu pada tingkat {lvl}.',writtenBtn:'Soal esai ✍️',reviewLbl:'Ulasan: ',writtenDone:'Kamu telah menyelesaikan soal esai.',back:'Kembali',answerPh:'Tulis jawabanmu di sini…',gradeMine:'Nilai jawaban saya',answerFirst:'Tulis jawabanmu terlebih dahulu.',grading:'Sedang menilai…',youCovered:'Yang sudah kamu jawab dengan benar:',youMissed:'Yang kamu lewatkan:',gradedAgainst:'Berdasarkan apa jawaban saya dinilai?',contest:'Ajukan keberatan',studyEstimate:'Ini adalah perkiraan belajar, bukan nilai resmi.',whyUnfair:'Menurutmu mengapa penilaian ini tidak adil?',gradeFail:'Penilaian gagal.',close:'Tutup',uploadSub:'PDF, gambar, atau DOCX',pastePh:'Tempel teks kuliah di sini...',lessonsWord:'pelajaran',docxFail:'File DOCX tidak dapat dibaca — coba simpan sebagai PDF.',tooBig:'File terlalu besar (batas sekitar 10 MB).',cardsDone:'Kamu telah menyelesaikan semua kartu! 🎉',streakWord:'hari',examLangLabel:'Bahasa ujian saya',examLangHint:'Penjelasan tetap dalam bahasa Anda; istilah mengikuti bahasa ujian.',subjGeneric:'Umum',okBtn:'OK',badType:'Jenis file ini tidak didukung di sini. Unggah materi kuliah menerima: PDF, DOCX, ZIP, atau gambar.',badTypeHint:'File kode dan proyek diunggah melalui tombol 📎 lampirkan di obrolan.',zipNoText:'Tidak ada teks yang dapat dibaca di dalam arsip. Unggah PDF atau gambar materi kuliah.',zipEmpty:'Arsip tidak berisi teks.',zipOpenFail:'Arsip tidak dapat dibuka.',zipToolFail:'Alat unzip tidak dapat dimuat. Periksa koneksi Anda.'},
fil:{title:'Aking Aralin',oldEdu:'📚 Mga Kurso at Aralin',upload:'Mag-upload ng bagong lektura',orPaste:'o mag-paste ng teksto',analyze:'Suriin ang lektura',analyzing:'⏳ Sinusuri ang lektura…',mySubjects:'📚 Aking mga asignatura',empty:'Wala pang aralin — i-upload ang unang lektura!',summaryTab:'📄 Buod',cardsTab:'🎴 Cards',quizTab:'✍️ Pagsusulit',know:'Alam ko ✅',review:'Ulitin 🔄',tapFlip:'I-tap ang card para baligtarin',retry:'Ulitin ang pagsusulit',yourScore:'Iskor mo',great:'Mahusay! Handa ka na 🌟',good:'Napakahusay! Balikan ang mga mali 💪',keepGoing:'Magandang simula — basahin ang buod at subukan muli 📖',del:'Burahin',confirmDel:'Burahin ang araling ito?',err:'May naganap na error, subukan muli.',guestNote:'Hindi naka-login — dito lang sa device naka-save.',intro:'Bago: 🎓 Aking Aralin — buod, cards at pagsusulit nang awtomatiko',introBtn:'Subukan',hint:'💡 Subukan ang "Aking Aralin": buod, cards at quiz mula sa lektura',next:'Susunod',finish:'Tapos',lvlBasic:'Batayan',lvlMid:'Katamtaman',lvlAdv:'Advanced',focusLevel:'Ituon ang iyong pagrepaso sa antas na {lvl}.',writtenBtn:'Mga Tanong sa Sanaysay ✍️',reviewLbl:'Balik-aral: ',writtenDone:'Natapos mo na ang mga tanong sa sanaysay.',back:'Bumalik',answerPh:'Isulat ang iyong sagot dito…',gradeMine:'I-grade ang sagot ko',answerFirst:'Isulat muna ang iyong sagot.',grading:'Ginagrado…',youCovered:'Nasagot mo:',youMissed:'Nakaligtaan mo:',gradedAgainst:'Ano ang basehan ng grado ko?',contest:'Kontestahin ito',studyEstimate:'Tantiya lang ito para sa pag-aaral, hindi opisyal na grado.',whyUnfair:'Bakit mo naisip na hindi patas ang pag-grade?',gradeFail:'Nabigo ang pag-grade.',close:'Isara',uploadSub:'PDF, larawan, o DOCX',pastePh:'I-paste ang teksto ng lecture mo dito...',lessonsWord:'aralin',docxFail:'Hindi mabasa ang DOCX file — subukang i-save bilang PDF.',tooBig:'Sobrang laki ng file (limitasyon ay humigit-kumulang 10 MB).',cardsDone:'Natapos mo ang lahat ng flashcards! 🎉',streakWord:'araw',examLangLabel:'Wika ng aking exam',examLangHint:'Nasa wika mo ang mga paliwanag; sinusunod ng mga terminolohiya ang wika ng exam.',subjGeneric:'Pangkalahatan',okBtn:'OK',badType:'Hindi suportado ang ganitong file type dito. Tumatanggap ang pag-upload ng lecture ng: PDF, DOCX, ZIP, o mga larawan.',badTypeHint:'Ang mga code at project file ay ina-upload gamit ang 📎 attach button sa chat.',zipNoText:'Walang mababasang teksto sa loob ng archive. Mag-upload ng PDF o larawan ng lecture.',zipEmpty:'Walang teksto sa archive.',zipOpenFail:'Hindi mabuksan ang archive.',zipToolFail:'Hindi ma-load ang unzip tool. Suriin ang iyong koneksyon.'},
tr:{title:'Derslerim',oldEdu:'📚 Kurslar ve Dersler',upload:'Yeni ders yükle',orPaste:'veya metin yapıştır',analyze:'Dersi analiz et',analyzing:'⏳ Ders analiz ediliyor…',mySubjects:'📚 Derslerim',empty:'Henüz ders yok — ilk dersini yükle!',summaryTab:'📄 Özet',cardsTab:'🎴 Kartlar',quizTab:'✍️ Sınav',know:'Biliyorum ✅',review:'Tekrar 🔄',tapFlip:'Çevirmek için karta dokun',retry:'Sınavı tekrarla',yourScore:'Puanın',great:'Mükemmel! Sınava hazırsın 🌟',good:'Çok iyi! Hatalarını gözden geçir 💪',keepGoing:'İyi başlangıç — özeti oku ve tekrar dene 📖',del:'Sil',confirmDel:'Bu ders silinsin mi?',err:'Bir hata oluştu, tekrar dene.',guestNote:'Giriş yapılmadı — dersler yalnızca bu cihazda saklanır.',intro:'Yeni: 🎓 Derslerim — otomatik özet, kart ve sınav',introBtn:'Şimdi dene',hint:'💡 "Derslerim"i dene: dersinden özet, kart ve sınav',next:'İleri',finish:'Bitir',lvlBasic:'Temel',lvlMid:'Orta',lvlAdv:'İleri',focusLevel:'Tekrarını {lvl} seviyesine odakla.',writtenBtn:'Yazılı sorular ✍️',reviewLbl:'İncele: ',writtenDone:'Yazılı soruları tamamladın.',back:'Geri',answerPh:'Cevabını buraya yaz…',gradeMine:'Cevabımı değerlendir',answerFirst:'Önce cevabını yaz.',grading:'Değerlendiriliyor…',youCovered:'Doğru bildiklerin:',youMissed:'Kaçırdıkların:',gradedAgainst:'Cevabım neye göre değerlendirildi?',contest:'Bu değerlendirmeye itiraz et',studyEstimate:'Bu bir çalışma tahminidir, resmi bir not değildir.',whyUnfair:'Bu değerlendirmenin neden haksız olduğunu düşünüyorsun?',gradeFail:'Değerlendirme başarısız oldu.',close:'Kapat',uploadSub:'PDF, görsel veya DOCX',pastePh:'Ders metnini buraya yapıştır...',lessonsWord:'ders',docxFail:'DOCX dosyası okunamadı — PDF olarak kaydetmeyi dene.',tooBig:'Dosya çok büyük (sınır yaklaşık 10 MB).',cardsDone:'Tüm kartları tamamladın! 🎉',streakWord:'gün',examLangLabel:'Sınav dilim',examLangHint:'Açıklamalar kendi dilinizde kalır; terimler sınav diline göre olur.',subjGeneric:'Genel',okBtn:'Tamam',badType:'Bu dosya türü burada desteklenmiyor. Ders yüklemesi şunları kabul eder: PDF, DOCX, ZIP veya görseller.',badTypeHint:'Kod ve proje dosyaları sohbetteki 📎 ekle düğmesiyle yüklenir.',zipNoText:'Arşivin içinde okunabilir metin yok. Dersin PDF\'ini veya görsellerini yükleyin.',zipEmpty:'Arşivde hiç metin yok.',zipOpenFail:'Arşiv açılamadı.',zipToolFail:'Sıkıştırma açma aracı yüklenemedi. Bağlantınızı kontrol edin.'},
zh:{title:'我的课程',oldEdu:'📚 课程与讲解',upload:'上传新讲义',orPaste:'或粘贴文本',analyze:'分析讲义',analyzing:'⏳ 正在分析讲义…',mySubjects:'📚 我的科目',empty:'还没有课程——上传第一份讲义吧！',summaryTab:'📄 摘要',cardsTab:'🎴 卡片',quizTab:'✍️ 测验',know:'我会了 ✅',review:'再复习 🔄',tapFlip:'点击卡片翻面',retry:'重新测验',yourScore:'你的得分',great:'太棒了！你已准备好考试 🌟',good:'很好！复习一下错题 💪',keepGoing:'不错的开始——先看摘要再试一次 📖',del:'删除',confirmDel:'确定删除该课程？',err:'出错了，请重试。',guestNote:'未登录——课程仅保存在本设备。',intro:'新功能：🎓 我的课程——自动生成摘要、卡片和测验',introBtn:'立即体验',hint:'💡 试试「我的课程」：上传讲义自动生成摘要、卡片和测验',next:'下一题',finish:'完成',lvlBasic:'基础',lvlMid:'中等',lvlAdv:'高级',focusLevel:'请重点复习{lvl}级别的内容。',writtenBtn:'问答题 ✍️',reviewLbl:'复习： ',writtenDone:'你已完成所有问答题。',back:'返回',answerPh:'在此输入你的答案…',gradeMine:'评分我的答案',answerFirst:'请先输入你的答案。',grading:'正在评分…',youCovered:'你答对的部分：',youMissed:'你遗漏的部分：',gradedAgainst:'我的答案是根据什么评分的？',contest:'对此评分提出异议',studyEstimate:'这只是学习参考估分，并非正式成绩。',whyUnfair:'你认为这次评分为什么不公平？',gradeFail:'评分失败。',close:'关闭',uploadSub:'PDF、图片或 DOCX',pastePh:'将讲义文本粘贴到这里...',lessonsWord:'课',docxFail:'无法读取 DOCX 文件——请尝试将其保存为 PDF。',tooBig:'文件太大（限制约为 10 MB）。',cardsDone:'你已完成所有卡片！🎉',streakWord:'天',examLangLabel:'我的考试语言',examLangHint:'解释会保留在你的语言中；术语则遵循考试语言。',subjGeneric:'通用',okBtn:'好的',badType:'此文件类型在此不受支持。讲义上传仅接受：PDF、DOCX、ZIP 或图片。',badTypeHint:'代码和项目文件请通过聊天中的 📎 附件按钮上传。',zipNoText:'压缩包内没有可读文本。请上传讲义的 PDF 或图片。',zipEmpty:'压缩包中没有任何文本。',zipOpenFail:'无法打开压缩包。',zipToolFail:'无法加载解压工具。请检查你的网络连接。'},
ru:{title:'Мои уроки',oldEdu:'📚 Курсы и уроки',upload:'Загрузить новую лекцию',orPaste:'или вставьте текст',analyze:'Анализировать лекцию',analyzing:'⏳ Анализируем лекцию…',mySubjects:'📚 Мои предметы',empty:'Пока нет уроков — загрузите первую лекцию!',summaryTab:'📄 Конспект',cardsTab:'🎴 Карточки',quizTab:'✍️ Тест',know:'Знаю ✅',review:'Повторить 🔄',tapFlip:'Нажмите на карточку, чтобы перевернуть',retry:'Пройти тест снова',yourScore:'Ваш результат',great:'Отлично! Вы готовы к экзамену 🌟',good:'Очень хорошо! Повторите ошибки 💪',keepGoing:'Хорошее начало — перечитайте конспект и попробуйте снова 📖',del:'Удалить',confirmDel:'Удалить этот урок?',err:'Произошла ошибка, попробуйте снова.',guestNote:'Вы не вошли — уроки хранятся только на этом устройстве.',intro:'Новое: 🎓 Мои уроки — конспект, карточки и тест автоматически',introBtn:'Попробовать',hint:'💡 Попробуйте «Мои уроки»: конспект, карточки и тест из лекции',next:'Далее',finish:'Готово',lvlBasic:'Базовый',lvlMid:'Средний',lvlAdv:'Продвинутый',focusLevel:'Сосредоточь повторение на уровне «{lvl}».',writtenBtn:'Письменные вопросы ✍️',reviewLbl:'Повторение: ',writtenDone:'Ты закончил письменные вопросы.',back:'Назад',answerPh:'Напиши свой ответ здесь…',gradeMine:'Оценить мой ответ',answerFirst:'Сначала напиши ответ.',grading:'Идёт оценка…',youCovered:'Ты верно ответил на:',youMissed:'Ты упустил:',gradedAgainst:'На основании чего был оценён мой ответ?',contest:'Оспорить эту оценку',studyEstimate:'Это учебная оценка, а не официальная отметка.',whyUnfair:'Почему ты считаешь эту оценку несправедливой?',gradeFail:'Не удалось оценить.',close:'Закрыть',uploadSub:'PDF, изображения или DOCX',pastePh:'Вставь текст лекции сюда...',lessonsWord:'уроков',docxFail:'Не удалось прочитать файл DOCX — попробуй сохранить его как PDF.',tooBig:'Файл слишком большой (лимит около 10 МБ).',cardsDone:'Ты закончил все карточки! 🎉',streakWord:'дней',examLangLabel:'Язык моего экзамена',examLangHint:'Объяснения остаются на вашем языке; термины соответствуют языку экзамена.',subjGeneric:'Общее',okBtn:'Хорошо',badType:'Этот тип файла здесь не поддерживается. Загрузка лекции принимает: PDF, DOCX, ZIP или изображения.',badTypeHint:'Файлы кода и проектов загружаются через кнопку 📎 в чате.',zipNoText:'В архиве нет читаемого текста. Загрузите PDF или изображения лекции.',zipEmpty:'В архиве нет текста.',zipOpenFail:'Не удалось открыть архив.',zipToolFail:'Не удалось загрузить инструмент распаковки. Проверьте подключение.'},
es:{title:'Mis lecciones',oldEdu:'📚 Cursos y lecciones',upload:'Subir una nueva clase',orPaste:'o pega el texto',analyze:'Analizar la clase',analyzing:'⏳ Analizando la clase…',mySubjects:'📚 Mis materias',empty:'Aún no hay lecciones — ¡sube tu primera clase!',summaryTab:'📄 Resumen',cardsTab:'🎴 Tarjetas',quizTab:'✍️ Examen',know:'Lo sé ✅',review:'Repasar 🔄',tapFlip:'Toca la tarjeta para girarla',retry:'Repetir examen',yourScore:'Tu puntuación',great:'¡Excelente! Estás listo 🌟',good:'¡Muy bien! Repasa tus errores 💪',keepGoing:'Buen comienzo — repasa el resumen e inténtalo de nuevo 📖',del:'Eliminar',confirmDel:'¿Eliminar esta lección?',err:'Ocurrió un error, inténtalo de nuevo.',guestNote:'Sin iniciar sesión — las lecciones se guardan solo en este dispositivo.',intro:'Nuevo: 🎓 Mis lecciones — resumen, tarjetas y examen automáticos',introBtn:'Pruébalo',hint:'💡 Prueba «Mis lecciones»: resumen, tarjetas y examen de tu clase',next:'Siguiente',finish:'Terminar',lvlBasic:'Básico',lvlMid:'Intermedio',lvlAdv:'Avanzado',focusLevel:'Concentra tu repaso en el nivel {lvl}.',writtenBtn:'Preguntas de desarrollo ✍️',reviewLbl:'Repaso: ',writtenDone:'Terminaste las preguntas de desarrollo.',back:'Atrás',answerPh:'Escribe tu respuesta aquí…',gradeMine:'Corregir mi respuesta',answerFirst:'Escribe tu respuesta primero.',grading:'Corrigiendo…',youCovered:'Lo que respondiste bien:',youMissed:'Lo que te faltó:',gradedAgainst:'¿Con qué criterio se corrigió mi respuesta?',contest:'Impugnar esta corrección',studyEstimate:'Esto es una estimación de estudio, no una calificación oficial.',whyUnfair:'¿Por qué crees que esta corrección fue injusta?',gradeFail:'No se pudo corregir.',close:'Cerrar',uploadSub:'PDF, imágenes o DOCX',pastePh:'Pega aquí el texto de la clase...',lessonsWord:'lección(es)',docxFail:'No se pudo leer el archivo DOCX — intenta guardarlo como PDF.',tooBig:'El archivo es demasiado grande (el límite es de unos 10 MB).',cardsDone:'¡Terminaste todas las tarjetas! 🎉',streakWord:'día(s)',examLangLabel:'Mi idioma de examen',examLangHint:'Las explicaciones se mantienen en tu idioma; los términos siguen el idioma del examen.',subjGeneric:'General',okBtn:'Aceptar',badType:'Este tipo de archivo no se admite aquí. La carga de apuntes acepta: PDF, DOCX, ZIP o imágenes.',badTypeHint:'Los archivos de código y proyectos se suben con el botón 📎 adjuntar en el chat.',zipNoText:'No hay texto legible dentro del archivo. Sube un PDF o imágenes de la clase.',zipEmpty:'El archivo no contiene texto.',zipOpenFail:'No se pudo abrir el archivo.',zipToolFail:'No se pudo cargar la herramienta de descompresión. Revisa tu conexión.'},
ml:{title:'എന്റെ പാഠങ്ങൾ',oldEdu:'📚 കോഴ്സുകളും പാഠങ്ങളും',upload:'പുതിയ ലക്ചർ അപ്‌ലോഡ് ചെയ്യുക',orPaste:'അല്ലെങ്കിൽ ടെക്സ്റ്റ് ഒട്ടിക്കുക',analyze:'ലക്ചർ വിശകലനം ചെയ്യുക',analyzing:'⏳ ലക്ചർ വിശകലനം ചെയ്യുന്നു…',mySubjects:'📚 എന്റെ വിഷയങ്ങൾ',empty:'ഇതുവരെ പാഠങ്ങളില്ല — ആദ്യ ലക്ചർ അപ്‌ലോഡ് ചെയ്യൂ!',summaryTab:'📄 സംഗ്രഹം',cardsTab:'🎴 കാർഡുകൾ',quizTab:'✍️ ക്വിസ്',know:'അറിയാം ✅',review:'വീണ്ടും 🔄',tapFlip:'മറിക്കാൻ കാർഡിൽ ടാപ്പ് ചെയ്യുക',retry:'ക്വിസ് വീണ്ടും',yourScore:'നിങ്ങളുടെ സ്കോർ',great:'മികച്ചത്! നിങ്ങൾ തയ്യാർ 🌟',good:'വളരെ നല്ലത്! തെറ്റുകൾ അവലോകനം ചെയ്യുക 💪',keepGoing:'നല്ല തുടക്കം — സംഗ്രഹം വായിച്ച് വീണ്ടും ശ്രമിക്കൂ 📖',del:'ഇല്ലാതാക്കുക',confirmDel:'ഈ പാഠം ഇല്ലാതാക്കണോ?',err:'പിശക് സംഭവിച്ചു, വീണ്ടും ശ്രമിക്കുക.',guestNote:'ലോഗിൻ ചെയ്തിട്ടില്ല — പാഠങ്ങൾ ഈ ഉപകരണത്തിൽ മാത്രം.',intro:'പുതിയത്: 🎓 എന്റെ പാഠങ്ങൾ — സംഗ്രഹം, കാർഡുകൾ, ക്വിസ്',introBtn:'ഇപ്പോൾ ശ്രമിക്കൂ',hint:'💡 «എന്റെ പാഠങ്ങൾ» ശ്രമിക്കൂ: ലക്ചറിൽ നിന്ന് സംഗ്രഹവും കാർഡുകളും ക്വിസും',next:'അടുത്തത്',finish:'പൂർത്തിയാക്കുക',lvlBasic:'അടിസ്ഥാനം',lvlMid:'ഇടത്തരം',lvlAdv:'ഉന്നതം',focusLevel:'{lvl} നിലവാരത്തിൽ നിങ്ങളുടെ അവലോകനം കേന്ദ്രീകരിക്കുക.',writtenBtn:'എഴുത്തു ചോദ്യങ്ങൾ ✍️',reviewLbl:'അവലോകനം: ',writtenDone:'നിങ്ങൾ എഴുത്തു ചോദ്യങ്ങൾ പൂർത്തിയാക്കി.',back:'തിരികെ',answerPh:'നിങ്ങളുടെ ഉത്തരം ഇവിടെ എഴുതുക…',gradeMine:'എന്റെ ഉത്തരം വിലയിരുത്തുക',answerFirst:'ആദ്യം നിങ്ങളുടെ ഉത്തരം എഴുതുക.',grading:'വിലയിരുത്തുന്നു…',youCovered:'നിങ്ങൾ ശരിയായി ഉൾപ്പെടുത്തിയത്:',youMissed:'നിങ്ങൾക്ക് വിട്ടുപോയത്:',gradedAgainst:'എന്റെ ഉത്തരം എന്തിന്റെ അടിസ്ഥാനത്തിലാണ് വിലയിരുത്തിയത്?',contest:'ഈ വിലയിരുത്തൽ ചോദ്യം ചെയ്യുക',studyEstimate:'ഇത് ഒരു പഠന എസ്റ്റിമേറ്റ് ആണ്, ഔദ്യോഗിക മാർക്ക് അല്ല.',whyUnfair:'ഈ വിലയിരുത്തൽ അന്യായമാണെന്ന് നിങ്ങൾ കരുതുന്നത് എന്തുകൊണ്ട്?',gradeFail:'വിലയിരുത്താൻ സാധിച്ചില്ല.',close:'അടയ്ക്കുക',uploadSub:'PDF, ചിത്രങ്ങൾ അല്ലെങ്കിൽ DOCX',pastePh:'ലക്ചർ ടെക്സ്റ്റ് ഇവിടെ പേസ്റ്റ് ചെയ്യുക...',lessonsWord:'പാഠം',docxFail:'DOCX ഫയൽ വായിക്കാൻ കഴിഞ്ഞില്ല — ഇത് PDF ആയി സേവ് ചെയ്ത് ശ്രമിക്കുക.',tooBig:'ഫയൽ വളരെ വലുതാണ് (പരിധി ഏകദേശം 10 MB ആണ്).',cardsDone:'നിങ്ങൾ എല്ലാ കാർഡുകളും പൂർത്തിയാക്കി! 🎉',streakWord:'ദിവസം',examLangLabel:'എൻ്റെ പരീക്ഷാ ഭാഷ',examLangHint:'വിശദീകരണങ്ങൾ നിങ്ങളുടെ ഭാഷയിൽ തുടരും; സാങ്കേതിക പദങ്ങൾ പരീക്ഷയുടെ ഭാഷ പിന്തുടരും.',subjGeneric:'പൊതു',okBtn:'ശരി',badType:'ഈ ഫയൽ തരം ഇവിടെ പിന്തുണയ്ക്കുന്നില്ല. ലെക്ചർ അപ്‌ലോഡ് സ്വീകരിക്കുന്നത്: PDF, DOCX, ZIP അല്ലെങ്കിൽ ചിത്രങ്ങൾ.',badTypeHint:'കോഡും പ്രോജക്റ്റ് ഫയലുകളും ചാറ്റിലെ 📎 അറ്റാച്ച് ബട്ടൺ ഉപയോഗിച്ച് അപ്‌ലോഡ് ചെയ്യുക.',zipNoText:'ആർക്കൈവിനുള്ളിൽ വായിക്കാവുന്ന ടെക്സ്റ്റ് ഇല്ല. ലെക്ചറിന്റെ PDF അല്ലെങ്കിൽ ചിത്രങ്ങൾ അപ്‌ലോഡ് ചെയ്യുക.',zipEmpty:'ആർക്കൈവിൽ ടെക്സ്റ്റ് ഒന്നും ഇല്ല.',zipOpenFail:'ആർക്കൈവ് തുറക്കാൻ കഴിഞ്ഞില്ല.',zipToolFail:'അൺസിപ്പ് ടൂൾ ലോഡ് ചെയ്യാൻ കഴിഞ്ഞില്ല. നിങ്ങളുടെ കണക്ഷൻ പരിശോധിക്കുക.'}
};
...
function openModal(){
  ...
  var _cb=document.getElementById('eduCloseBtn'); if(_cb) _cb.title=T('close');
...
function renderQuiz(pane,lesson){
  ...
  var LABEL={basic:T('lvlBasic'),mid:T('lvlMid'),advanced:T('lvlAdv')};
  ...
  function finish(){
    ...
    if(weak!==null&&s3[weak]<70){
      html+='<p style="font-size: var(--fs-3);line-height:1.8;max-width:340px;margin:6px auto 0;">'
        +esc(T('focusLevel')).replace('{lvl}','<b>'+esc(LABEL[weak])+'</b>')+'</p>';
    }
    ...
    if(written.length) html+='<button class="eduPrimary" id="eduWritten" style="background:transparent;border:1px solid currentColor;">'+esc(T('writtenBtn'))+'</button>';
    html+='</div></div>';
    pane.innerHTML=html;
  ...
  function draw(){
    ...
    pane.querySelectorAll('.eduQOpt').forEach(function(btn){
      btn.onclick=function(){
        ...
        if(!ok&&q.section) ex+=(ex?'<br>':'')+'📌 '+esc(T('reviewLbl'))+'<b>'+esc(q.section)+'</b>';
...
function renderWritten(pane,lesson,written){
  ...
  function draw(){
    if(i>=written.length){
      pane.innerHTML='<div class="eduCenter"><div style="font-size:34px;margin-bottom:10px;">✍️</div>'
        +'<p style="font-size: var(--fs-2);">'+esc(T('writtenDone'))+'</p>'
        +'<button class="eduPrimary" id="eduBackQuiz">'+esc(T('back'))+'</button></div>';
    ...
    pane.innerHTML='<div style="font-size:12px;opacity:.7;margin-bottom:8px;">'+(i+1)+' / '+written.length+' · ✍️</div>'
      ...
      +'<textarea id="eduAns" rows="6" placeholder="'+esc(T('answerPh'))+'" '
      ...
      +'<div style="text-align:center;margin-top:12px;"><button class="eduPrimary" id="eduGrade">'+esc(T('gradeMine'))+'</button></div>'
  ...
  function grade(w,answer,dispute){
    ...
    if(!answer||!answer.trim()){ out.innerHTML='<div class="eduExplain">'+esc(T('answerFirst'))+'</div>'; return; }
    if(btn){ btn.disabled=true; btn.textContent=T('grading'); }
    api({action:'grade',question:w.q,rubric:w.rubric||[],answer:answer,dispute:dispute||undefined})
      .then(function(j){
        ...
        if((g.covered||[]).length){
          html+='<div style="font-size: var(--fs-3);line-height:1.9;margin-bottom:8px;"><b>✅ '+esc(T('youCovered'))+'</b><ul style="margin:4px 0 0;padding-inline-start:20px;">';
          g.covered.forEach(function(c){ html+='<li>'+esc(c)+'</li>'; }); html+='</ul></div>';
        }
        if((g.missing||[]).length){
          html+='<div style="font-size: var(--fs-3);line-height:1.9;margin-bottom:8px;"><b>⚠️ '+esc(T('youMissed'))+'</b><ul style="margin:4px 0 0;padding-inline-start:20px;">';
        ...
        if(g.review) html+='<p style="font-size:13px;opacity:.8;margin:8px 0 0;">📌 '+esc(T('reviewLbl'))+'<b>'+esc(g.review)+'</b></p>';
        /* The model is not infallible — always show the rubric it judged
           against, and let the student contest the result. */
        if((g.rubric||[]).length){
          html+='<details style="margin-top:10px;"><summary style="font-size:12px;opacity:.75;cursor:pointer;">'+esc(T('gradedAgainst'))+'</summary>'
        ...
        html+='<div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:14px;">'
          +'<button class="eduPrimary" id="eduNextW">'+esc(i===written.length-1?T('finish'):T('next'))+'</button>'
          +'<button class="eduPrimary" id="eduDispute" style="background:transparent;border:1px solid currentColor;">'+esc(T('contest'))+'</button>'
          +'</div><p style="font-size: var(--fs-5);opacity:.6;margin:10px 0 0;">'+esc(T('studyEstimate'))+'</p></div>';
        out.innerHTML=html;
        if(btn){ btn.disabled=false; btn.textContent=T('gradeMine'); }
        document.getElementById('eduNextW').onclick=function(){ i++; draw(); };
        document.getElementById('eduDispute').onclick=function(){
          var why=prompt(T('whyUnfair'));
          if(why&&why.trim()) grade(w,document.getElementById('eduAns').value,why.trim());
        };
      })
      .catch(function(e){
        out.innerHTML='<div class="eduExplain">'+esc(e.message||T('gradeFail'))+'</div>';
        if(btn){ btn.disabled=false; btn.textContent=T('gradeMine'); }
      });
  }
  draw();
...
function eduExamLangControl(){
  ...
  var label=T('examLangLabel');
  var hint=T('examLangHint');
...
function processContent(payload){
  ...
  api(Object.assign({action:'process',nativeLang:eduNativeLang(),examLang:eduExamLang()},payload)).then(function(j){
    ...
    return listLessons().then(function(r){
      ...
      var subj=L.subject||T('subjGeneric');
      var lesson={
...
function handleArchive(file){
  ...
  function fail(msg){
    body.innerHTML='<div class="eduCenter"><p style="font-size: var(--fs-3);line-height:1.9">'+esc(msg)+'</p>'+
      '<button class="eduPrimary" id="eduErrBack">'+T('okBtn')+'</button></div>';
  ...
  function run(){
    file.arrayBuffer().then(function(buf){ return window.JSZip.loadAsync(buf); })
      .then(function(zip){
        ...
        if(!names.length) throw new Error(T('zipNoText'));
        return Promise.all(names.map(function(n){
          return zip.files[n].async('string').then(function(t){ return '— '+n+' —\n'+t; });
        })).then(function(parts){ return parts.join('\n\n').slice(0,60000); });
      })
      .then(function(txt){
        if(!txt.trim()) throw new Error(T('zipEmpty'));
        processContent({text:txt,lang:appLang()});
      })
      .catch(function(e){ fail(e.message||T('zipOpenFail')); });
  }
  if(window.JSZip) run();
  else{
    var sc=document.createElement('script');
    sc.src='https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js';
    sc.onload=run; sc.onerror=function(){ fail(T('zipToolFail')); };
