...
const I18N = {
  ar: {
    ...
    tvTitle: '📺 تلفزيون', tvSportsWorld: 'رياضة العالم', tvDirect: 'بث مباشر',
...
- بايثون = فقط إذا طُلب صراحة. كتلة \`\`\`python واحدة.`,
  ...
  en: {
    ...
    tvTitle: '📺 TV', tvSportsWorld: 'World Sports', tvDirect: 'Live stream',
