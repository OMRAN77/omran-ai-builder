...
const SPEC = {
  ...
  SUB_DAILY_MAX:          ['tunable', 'بديل: ٢٥٠ — سقف حماية باقة ماكس (v-plan-routing)'],
  FREE_CHAIN:             ['tunable', 'بديل: groq,gemini,mistral,openrouter — ترتيب السلسلة المجانية (Groq أوّلًا — v-plan-routing)'],
  FREE_GEMINI_MODEL:      ['tunable', 'يُجرَّب أولًا ثم قائمة مرشّحين ثم استكشاف /models (tier.js)'],
  ...
  REPLICATE_API_TOKEN:    ['feature', 'ترقية دقّة الصور (مكبّر Real-ESRGAN) — بدونه تُعاد الصورة كما هي (v-img-upscale)'],
  IMAGE_UPSCALE:          ['tunable', 'off يعطّل الترقية التلقائيّة لنواتج الصور دون 2K'],
  UPSCALE_MAX_MS:         ['tunable', 'بديل: ٦٠٠٠٠ — مهلة الترقية'],
  UPSCALE_MODEL:          ['tunable', 'بديل: nightmareai/real-esrgan'],
