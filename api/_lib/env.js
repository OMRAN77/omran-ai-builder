...
const SPEC = {
  ...
  FREE_DAILY:             ['tunable', 'بديل: ١٠ — رسائل المسجَّل المجاني يوميًّا'],
  GUEST_DAILY:            ['tunable', 'بديل: ٣ — رسائل الضيف يوميًّا'],
  SUB_DAILY_BASIC:        ['tunable', 'بديل: ٥٠ — سقف حماية باقة عادية'],
  SUB_DAILY_PRO:          ['tunable', 'بديل: ١٥٠ — سقف حماية باقة برو'],
  SUB_DAILY_MAX:          ['tunable', 'بديل: ٤٠٠ — سقف حماية باقة ماكس'],
  FREE_CHAIN:             ['tunable', 'بديل: gemini,groq,mistral,openrouter — ترتيب السلسلة المجانية'],
  FREE_GEMINI_MODEL:      ['tunable', 'بديل: gemini-2.5-flash'],
  FREE_GROQ_MODEL:        ['tunable', 'بديل: llama-3.3-70b-versatile'],
  FREE_MISTRAL_MODEL:     ['tunable', 'بديل: mistral-large-latest'],
  FREE_OPENROUTER_MODEL:  ['tunable', 'بديل: meta-llama/llama-3.3-70b-instruct:free'],
