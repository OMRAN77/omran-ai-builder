...
const WIZARD_RE = /كتالوج|كتالوق|منيو|قائمة طعام|قائمة الطعام|بروفايل شرك/;
    ...
    'سؤال طبخ أو وصفة: استدعِ معًا في نفس الجولة web_search عن الوصفة وgenerate_image بوصف فوتوغرافي شهي للطبق نفسه (professional food photography). ضع رمز الصورة وحده في أول سطر من ردك ثم الوصفة، واختم بروابط موقعين للطبخ أو أكثر من نتائج بحثك.\n';
