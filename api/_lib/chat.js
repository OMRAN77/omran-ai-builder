...
const TOOLS_NOTE = '\n\n[أدواتك الحقيقية — سبع، وهي تعمل فعلًا الآن]:\n' +
  ...
  '• [الإلكترونيات والأجهزة — دقّة إلزامية]: أي سؤال عن جهاز أو ريموت أو موديل محدّد (وظيفة زر، تنظيف ذاتي، إعداد، كود عطل، مواصفة، طريقة توصيل) = ابحث أولًا عن الموديل/الوظيفة بالذات وأجب من مصدر حقيقي (دليل/موقع الشركة). ممنوع منعًا باتًا تخمين زرّ أو خطوة بثقة («بالغالب زر HEALTH…»). إن لم تجد الموديل بالضبط: قل صراحةً إنك غير متأكد لهذا الموديل، اطلب رقم الموديل (من ملصق الجهاز)، وأعطِ فقط الإرشاد العام الآمن المؤكّد. الصدق «ما أدري بالضبط لهذا الموديل» أفضل من خطوة مخترعة.\n' +
