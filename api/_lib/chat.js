...
const TOOLS_NOTE = '\n\n[أدواتك الحقيقية — خمس، وهي تعمل فعلًا الآن]:\n' +
  ...
  '• [قاعدة الصورة التوضيحية]: إذا طلب المستخدم صورة أو فيديو توضيحيًا عن موضوع يناقشه في المحادثة (مثل «صور توضيحية» أو «فيديو يوضح»): استدعِ generate_image مع وصف بصري دقيق مستخرَج من موضوع المحادثة (مخطط · رسم تفسيري · تصور). ممنوع استخدام web_search للحصول على صور توضيحية؛ الصور العشوائية من الإنترنت لا توضّح.\n' +
  ...
  '(ص٢) إن كان الجواب أماكن (عيادة · مستشفى · طبيب · مطعم · متجر · جهة حكوميّة): ضع تحت كلّ مكان سطرًا مستقلًّا بهذه الصيغة حرفيًّا: إن أعطتك أداة رابط خرائط حقيقيًا (سطر «الرابط» في بطاقة Google Maps) فضعه حرفيًا داخل قوسي الرابط ولا تولّد رابط بحث؛ وإن لم تُعطَ رابطًا فالصيغة: [📍 افتح في الخرائط](https://www.google.com/maps/search/?api=1&query=اسم+المكان+المدينة) — المسافات تُستبدل بعلامة + والاسم يُكتب كما هو. ولا تكتب هذا السطر للفنادق والمنتجعات — لها صيغتها في (ص٢-ج).\n' +
  '(ص٢-ج) إن كان الجواب فنادق أو منتجعات أو شاليهات: لا تكتب سطر الخرائط أبدًا، وممنوع منعًا باتًا وضع روابط حجز تحت الفنادق واحدًا واحدًا أو تكرار منصّات الحجز أكثر من مرّة واحدة في الردّ كلّه. اكتب قائمة الفنادق نصًّا نظيفًا بلا أيّ رابط، ثمّ في آخر الردّ فقط أضف سطرًا واحدًا لا يتكرّر بهذه الصيغة حرفيًّا: للحجز والمقارنة: [بوكينج](https://www.booking.com/searchresults.html?ss=hotels+in+CITY) · [أجودا](https://www.agoda.com/search?q=hotels+in+CITY) · [تريفاجو](https://www.trivago.ae/ar/srl?query=hotels+in+CITY) — استبدل CITY في الروابط الثلاثة باسم المدينة أو المنطقة التي سأل عنها المستخدم مكتوبةً بالإنجليزيّة والمسافات بعلامة +، وممنوع وضع اسم فندق بعينه في أيّ رابط. ولا تضف [تاج](https://tajj.app/) إلى السطر إلّا إن كانت الوجهة داخل الإمارات — «تاج» منصّة إماراتيّة، وذكرها لوجهة خارج الإمارات ممنوع.\n' +
  ...
  '(ص٢-د) إن كان السؤال عن السفر من دولة إلى دولة أو عن تأشيرة أو دخول أو إقامة أو سفارة: ابحث أوّلًا — ممنوع الاعتماد على ذاكرتك في شروط الدخول لأنّها تتغيّر. وإن لم يذكر المستخدم جنسيّته فاعتبرها دولة المغادرة واذكر ذلك في نصف سطر، ولا تسأله قبل الجواب. واذكر بهذا الترتيب: هل تلزم تأشيرة أم لا، ثمّ نوعها ومدّتها، ثمّ طريقة التقديم: إلكترونيًّا أم بموعد في السفارة أو القنصليّة. ثمّ أضف سطرًا واحدًا بهذه الصيغة حرفيًّا: [🛂 الموقع الرسميّ للتأشيرة](الرابط الرسميّ من نتيجة البحث) · [🏛️ سفارة الوجهة](https://www.google.com/maps/search/?api=1&query=Embassy+of+DEST+in+ORIGIN) — استبدل DEST بدولة الوجهة وORIGIN بدولة المغادرة بالإنجليزيّة والمسافات بعلامة +. ممنوع اختراع رابط رسميّ أو رسوم أو مدّة معالجة بلا مصدر من البحث.\n' +
...
const ANSWER_FIRST_NOTE = '\n\n[أجب أوّلًا — إلزاميّ في هذا الردّ]:\n' +
  ...
  'ممنوع أن تسأله عن المدينة أو المنطقة أو الميزانيّة أو النوع أو الغرض قبل الجواب — افترض الأوسع، وقل ما افترضتَه في نصف سطر.\n' +
  'التضييق بعد الجواب لا قبله: حين تنتهي المعلومة يجوز سطر واحد قصير أو بطاقات خيارات لتعميق البحث.\n' +
...
const GLOBAL_NOTE = '\n\n[سؤال عن مكان خارج الإمارات — إلزاميّ في هذا الردّ]:\n'
  ...
  + '٣) إن رجعت لك بطاقات أماكن فيها «المصدر: Google Maps» فالتزم بأمر العرض المرفق معها، واعرض لكلّ مكان تقييمه وعدد مراجعاته وعنوانه ورابط خرائطه كما أُعطي لك حرفيًا — بيانات حيّة ممنوع حذفها أو اختصارها.\n'
...
const WIZARD_RE = /كتالوج|كتالوق|منيو|قائمة طعام|قائمة الطعام|بروفايل شرك/;
    ...
    const TOOL_INTENT_RE = /ابحث|بحث|خبر|أخبار|اخبار|سعر|أسعار|اسعار|طقس|نتيجة|الرابط|المصدر|اليوم|الآن|اﻵن|مطعم|عيادة|مستشفى|متجر|وظيفة|وظائف|عقار|سيارة|خرائط|صورة|صور|فيديو|فديو|مقطع|توضيح|توضيحي|توضيحية|شرح مرئي|ارسم|تصميم|كود|احسب|احسبها|شغّل|شغل|اختبر|ابني|بناء|صمّم|صمم|أنشئ|انشئ|تطبيق|موقع|صفحة|أداة|web\s?search|latest|news|price|weather|source|image|video|draw|code|calculate|run|test|build|create|website|app|tool/i;
...
function placeCards(places) {
  const cards = places.map((p, i) => [
    ...
    p.type ? ('النوع: ' + p.type) : '',
    p.price ? ('مستوى السعر: ' + (PRICE_AR[p.price] || p.price)) : '',
    p.address ? ('العنوان: ' + p.address) : '',
    p.site ? ('الموقع: ' + cleanLink(p.site)) : '',
    p.url ? ('الرابط: ' + cleanLink(p.url)) : '',
    'المصدر: Google Maps',
  ].filter(Boolean).join('\n')).join('\n\n');
  // 🎯 v617 — عشرون اسمًا بلا ترجيح = قائمة عامّة. المطلوب ثلاثة مطابقة مع سبب.
  return cards + '\n\n[إلزاميّ في عرض هذه الأماكن]: لا تعرض القائمة كلّها. اختر منها ثلاثة إلى خمسة هي الأقرب لطلب المستخدم بالذّات '
    + '(نوع المطبخ · الميزانيّة · الأجواء · حلال إن ذكره)، ورتّبها بالأنسب أوّلًا. لكلّ مكان: اسمه، ثمّ سطر واحد يشرح لماذا اخترته لهذا الطلب تحديدًا، '
    + 'ثمّ ⭐ التقييم (عدد المراجعات) ومستوى السعر إن وُجد، ثمّ العنوان. واستعمل قيمة «الرابط» أعلاه حرفيًا في سطر الخرائط — ممنوع توليد رابط بحث من الاسم. '
    + 'إن لم يطابق أيّ مكان قيدًا ذكره المستخدم فقل ذلك صراحة ولا تدّعِ مطابقة لم ترجع من الأداة.';
}
