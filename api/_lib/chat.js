...
const TOOLS = [
  {
    name: 'web_search',
    description: 'ابحث في الإنترنت الآن. إجباري لأي سعر أو خبر أو طقس أو نتيجة مباراة أو رسوم رسمية أو أي معلومة قد تكون تغيّرت بعد تدريبك.',
...
const TOOLS_NOTE = '\n\n[أدواتك الحقيقية — خمس، وهي تعمل فعلًا الآن]:\n' +
  ...
  '(٤) بعد الأدوات: أجب بإيجاز، واذكر مصدر أي رقم، ولا تلصق نتائج البحث خامًا.\n' +
