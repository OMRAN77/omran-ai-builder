...
const GLOBAL_NOTE = '\n\n[سؤال عن مكان خارج الإمارات — إلزاميّ في هذا الردّ]:\n'
  ...
  + '٣) اعرض مصادر تلك الدولة نفسها بروابطها كما رجعت من البحث حرفيًّا، ولا تخترع رابطًا ولا تُصلح رابطًا ناقصًا. التنسيق إلزاميّ: لكلّ موقع سطران — الأوّل اسمه العربيّ ثمّ شرطة ثمّ وصف قصير بلا أيّ رابط، والثاني رابطه وحده في سطر مستقلّ بصيغة [اسم قصير](الرابط). ممنوع وضع رابط داخل جملة أو في سطر فيه نصّ آخر، وممنوع كتابة الرابط عاريًا، ولا تبدأ أيّ سطر بحرف لاتينيّ.\n'
