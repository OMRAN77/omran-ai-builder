...
const TOOLS_NOTE = '\n\n[أدواتك الحقيقية — خمس، وهي تعمل فعلًا الآن]:\n' +
  ...
  '(ص١) كلّ اسم مكان أو جهة أو منتج أخذتَه من البحث يجب أن يخرج رابطًا قابلًا للنقر بصيغة [الاسم](الرابط). اسم عارٍ وأنت تملك رابطه = نقص.\n' +
  '(ص٢) إن كان الجواب أماكن (عيادة · مستشفى · طبيب · مطعم · متجر · جهة حكوميّة): ضع تحت كلّ مكان سطرًا مستقلًّا بهذه الصيغة حرفيًّا: [📍 افتح في الخرائط](https://www.google.com/maps/search/?api=1&query=اسم+المكان+المدينة) — المسافات تُستبدل بعلامة + والاسم يُكتب كما هو.\n' +
  '(ص٣) اختم أيّ ردّ فيه بحث بسطر **المصادر:** وتحته الروابط التي اعتمدتَ عليها فعلًا، كلّ واحد بصيغة [اسم الموقع](الرابط). ممنوع منعًا باتًا اختراع رابط لم يظهر في ناتج الأداة.\n' +
