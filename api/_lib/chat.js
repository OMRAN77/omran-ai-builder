...
module.exports = async (req, res) => {
  ...
  const toolTurn = !quietSocialTurn && !__analyzeDoc;
    ...
    const IMAGE_GATE_NOTE = lastUserHasImage ? '' :
      '\n\n[قاعدة الصور — إلزاميّة مطلقة تغلب ما سبق]: لا ترسم صورةً توضيحيّة تلقائيّة لقصّة أو شرح أو تقرير أو سؤال أو نصّ سرديّ أو تعليميّ أو دينيّ أو تاريخيّ مهما كان موضوعه — ردّ بالنصّ فقط. استدعِ generate_image فقط في إحدى حالتين: (أ) طلب المستخدم صورةً صراحةً في رسالته (مثل «ارسم/صمّم/اصنع/ولّد لي صورة أو بوستر أو شعار أو تصميم»)، أو (ب) كنت تبني تطبيقًا أو موقعًا أو صفحة داخل كتلة كود ```html تحتاج صورًا فعليّة. وعدا ذلك: نصّ فقط بلا أيّ صورة.';
