...
async function mergeWithModel(existing, userText, aiText) {
  const sys =
    ...
    /* v-maha-name: «مها» تتكرّر في كلام المستخدم لأنّه ينادي المساعدة الصوتيّة، فكانت مرشّحة لأن تُسجَّل اسمًا له. */
    '«مها» و«عمران» اسما مساعدَي التطبيق (الصوتيّة والنصّيّ) — لا تسجّلهما اسمًا للمستخدم أو لأحد من أهله مهما تكرّرا في كلامه، واحذفهما إن وُجدا كذلك في الملف القديم.\n' +
    'أسماء نماذج الذكاء الاصطناعي ومزوّديها (كلاود، جيميناي، جروك، ميسترال، جي بي تي وأمثالها) ليست مشاريع للمستخدم ولا حقائق عنه — لا تسجّلها في أيّ قسم، واحذف أيّ «مشروع» باسم واحد منها من الملف القديم.\n' +
